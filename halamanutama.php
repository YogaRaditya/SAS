...
<html lang="en">
  <head>
    ...
    <header class="p-3 text-bg-dark">
          ...
          <div class="pemandangan"><br><br>
            <div class="text-center text-white">
              <h1>PERISTIWA BANDUNG LAUTAN API</h1><br><br>
              <button type="button" class="btn btn-dark" onclick="window.location.href='Beranda.php'">Lanjutkan</button><br><br>
            </div>
                  <div class="col text-center text-white "><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                </div>
            </div>
